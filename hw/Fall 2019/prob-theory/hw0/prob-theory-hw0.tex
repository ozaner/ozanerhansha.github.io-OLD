...
\begin{center}
    \scalebox{.95}{
        \begin{tikzpicture}
            ...
            \addlegendentry{$2y\le x\le\infty$}
            ...
            \addlegendentry{$0\le y\le\infty$}
        ...
        \begin{tikzpicture}
            ...
            \addlegendentry{$0\le x\le\infty$}
...
% -Remove Address
% -Organize Coursework into CS, Math
% -Extracurricular Activities** 
% -qRNG - remove opensource, capitalize/bold Python
% - Remove FIRST Coach, Captain
% - Move Skills section up

% - Writing - add "read by n people"
% - Add more side projects
% - Extracurriculars: Rewrite to be more impressive? Minor reorganization, update descriptions.