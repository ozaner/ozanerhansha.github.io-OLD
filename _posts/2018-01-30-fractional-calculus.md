...
$$D^{1/2}D^{1/2}f=Df \tag{Because \(\frac{1}{2}+\frac{1}{2}=1\)}$$
...
#### The Gamma Function
This formula works for any integer order derivative but if we attempt to plug, say $\frac{1}{2}$, into the expression we're left with:
