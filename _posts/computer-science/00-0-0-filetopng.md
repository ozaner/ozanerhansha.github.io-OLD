...
Another similarity can be spotted after the last black bar. Pas this point, both the ROMs consist of 'garbage data' meant to fill up the cartridge they were stored on. You can tell because this section looks more like the random sample then the rest of the picture.
