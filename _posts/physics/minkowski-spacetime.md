...
## Definition
Formally speaking, Minkowski spacetime (which I'll simply refer to as *spacetime*) is an [algebraic structure](\abstract-algebra) that represents space purely in mathematical terms. In particular it is a 4D [vector space](https://en.wikipedia.org/wiki/Vector_space).
